...
$title_2 = get_field( "title_1" );
$main_title_2 = get_field("main_title_1");
$des_2 = get_field("des_1");
$image_2 = get_field("image_1");
$list_image_2 = get_field("list_image_1");
get_header();
?>
                ...
                <div class="row">
                    <div class="section-left col-xl-5 col-12">
                        <div class="inner">
                            ...
                            <a class="btn-contact" href="<?php echo $btn_url ?>">Liên hệ đặt dịch vụ</a>
                        </div>
                    </div>
